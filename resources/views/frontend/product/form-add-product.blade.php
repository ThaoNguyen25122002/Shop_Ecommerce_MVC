			...
			<div class="row">
				...
				<div class="col-sm-9">
					...
					@endif -->
						...
						<form action="{{ url('form-add-product') }}" method="post" enctype="multipart/form-data">
							@csrf
                            ...
                            <div class="col-sm-12 ">
                                <input type="number" name="discount_percentage" min="0" max="100"  value="{{ old('name') }}" placeholder="0" style="max-width: 50px;display: inline;"><span>%</span>
                            </div>
							...
							<textarea name="detail" placeholder="Detail" rows="4" cols="50">{{old('detail')}}
							</textarea>
							@error('detail')
                                <span style="color: red">{{ $message }}</span>
                            @enderror
